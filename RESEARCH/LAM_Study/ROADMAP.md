# Roadmap: LAM Action Tokenization Research

## Phase 1: Foundation (Completed)
- [x] Define Hypothesis: Hierarchical tokenization improves robustness.
- [x] Benchmark Definition: WebArena/AgentBench wrapper.
- [x] Literature Review: Identified gap in semantic alignment.
